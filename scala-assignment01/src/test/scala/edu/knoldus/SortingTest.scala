...
class SortingTest extends WordSpec {
  ...
  val sortedList: List[Int] = List(1, 2, 3, 4, 5, 8)
  val unSortedList: List[Int] = List(2, 3, 1, 5, 8, 4)
  val reversedList: List[Int] = List(5, 4, 3, 2, 8, 1)
  val listWithNegativeIntegers: List[Int] = List(1, -1, 2, -2,6)
